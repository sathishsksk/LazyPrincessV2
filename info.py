...
API_ID = int(environ.get('API_ID', '1677067'))
API_HASH = environ.get('API_HASH', '0d8c8aabe36b01db6a26a7f2780fa660')
BOT_TOKEN = environ.get('BOT_TOKEN', "5822625873:AAEwff4upTEbA0nj9B6HSZsukp4kT4POIRc")
...
PICS = (environ.get('PICS', 'https://telegra.ph/file/2cc7befec6699194fc42b.jpg')).split()

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1126746691').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001620891165').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1126746691').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Sathishsk:Sathishsk@cluster0.t32pzlo.mongodb.net/?retryWrites=true&w=majority")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002226798449')).split()]
